...
const translations = {
  en: {
    ...
    welcome: "Welcome",
    aboutMe: "About Me",
    introText: "Welcome to my architecture portfolio. This site showcases a selection of projects that reflect my approach to design, problem-solving, and spatial creativity",
    introText2:"Feel free to browse through the site to learn more. You can also find my contact information and CV in the Information section.",
    info: "In this section, you will find my CV, including my previous experiences and academic qualifications.",
  ...
  fr: {
    ...
    introText: "Bienvenue dans mon portfolio d'architecture. Ce site présente une sélection de projets qui reflètent mon approche du design, de la résolution de problèmes et de la créativité spatiale.",
    introText2:"N'hésitez pas à parcourir le site pour en savoir plus. Vous pouvez également trouver mes coordonnées et mon CV dans la section Informations.",
    info: "Dans cette section, vous trouverez mon CV, y compris mes expériences précédentes et mes qualifications académiques.",
